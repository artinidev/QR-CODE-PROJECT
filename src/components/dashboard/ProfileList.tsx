        ...
        <div className="min-h-screen bg-gray-50/50 dark:bg-zinc-950 p-4 md:p-8 flex flex-col overflow-hidden h-screen">
            ...
            <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 min-h-0">
                ...
                <div className="lg:col-span-8 flex flex-col gap-6 h-full min-h-0">
                    ...
                    <div className="flex-shrink-0 flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2 overflow-x-auto pb-2 md:pb-0 scrollbar-hide mask-fade-right">
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold transition-all whitespace-nowrap border ${selectedGroupId === null ? 'bg-primary text-primary-foreground border-primary shadow-md' : 'bg-white dark:bg-zinc-900 text-muted-foreground border-border hover:bg-muted'}`}
                            >
                                    ...
                                    <button
                                        ...
                                        className={`flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold transition-all whitespace-nowrap border 
                                            ${isSelected
                                                ...
                                                : `bg-white dark:bg-zinc-900 text-muted-foreground border-border hover:bg-muted`
                                            }`}
                                    >
                            ...
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold transition-all whitespace-nowrap border ${selectedGroupId === 'ungrouped' ? 'bg-primary text-primary-foreground border-primary' : 'bg-white dark:bg-zinc-900 text-muted-foreground border-border hover:bg-muted'}`}
                            >
                        ...
                        <div className="flex items-center gap-2 flex-shrink-0">
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-zinc-900 border border-border text-foreground rounded-full font-medium shadow-sm hover:bg-accent transition-all text-xs"
                            >
                    ...
                    {/* Main List Card */}
                    <div className="flex-1 bg-white dark:bg-zinc-900 rounded-[2rem] border border-border/60 shadow-sm overflow-hidden flex flex-col">

                        {/* Card Header: Search & Toggles */}
                        <div className="p-5 border-b border-border/40 flex flex-col sm:flex-row justify-between gap-4 items-center bg-muted/20">
                            <div className="flex bg-muted/50 p-1 rounded-lg border border-border/40">
                                <button
                                    onClick={() => setFilter('active')}
                                    className={`px-4 py-1.5 text-xs font-bold rounded-md transition-all ${filter === 'active' ? 'bg-white dark:bg-black shadow-sm text-foreground' : 'text-muted-foreground hover:text-foreground'}`}
                                >
                                    Active
                                </button>
                                <button
                                    onClick={() => setFilter('deleted')}
                                    className={`px-4 py-1.5 text-xs font-bold rounded-md transition-all ${filter === 'deleted' ? 'bg-white dark:bg-black shadow-sm text-foreground' : 'text-muted-foreground hover:text-foreground'}`}
                                >
                                    Trash
                                </button>
                            </div>
                        ...
                        <div className="flex-1 overflow-auto custom-scrollbar p-1">
                            <table className="w-full text-left text-sm border-spacing-y-2 border-separate px-4">
                                <thead className="text-xs font-semibold text-muted-foreground uppercase tracking-wider sticky top-0 bg-white dark:bg-zinc-900 z-10 shadow-sm">
                                    <tr>
                ...
                <div className="lg:col-span-4 h-full min-h-0 flex flex-col">
                    {activeProfile ? (
                        ...
                        <div className="flex-1 bg-white dark:bg-zinc-900 rounded-[2.5rem] border border-border/80 shadow-lg shadow-zinc-200/50 dark:shadow-black/50 p-8 flex flex-col items-center justify-center relative overflow-hidden group">
