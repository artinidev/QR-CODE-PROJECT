...
export default function MarketingCampaignBuilder() {
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`p-4 rounded-2xl border text-left flex items-center gap-4 transition-all ${formData.objective === opt.id
                                    ...
                                    >
                                        ...
                                        <span className={`font-semibold ${formData.objective === opt.id ? 'text-indigo-900 dark:text-indigo-300' : 'text-gray-700 dark:text-gray-300'}`}>
                                            {opt.label}
                                        </span>
                                    </button>
                                ))}
    ...
    return (
        <div className="min-h-screen p-6 bg-[#F8F9FE] dark:bg-slate-950 text-gray-900 dark:text-white pb-20 transition-colors duration-500">
            <div className="max-w-[1400px] mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400 max-w-xl text-lg ml-1">Create a new tracking-enabled QR campaign.</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-8">
                        <div className="bg-white dark:bg-zinc-800 rounded-3xl p-10 border border-gray-100 dark:border-white/10 shadow-sm min-h-[600px] flex flex-col justify-between">
